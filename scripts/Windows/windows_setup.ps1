...
# Execute python file to install package dependencies
# py ./graph_repo/local_setup.py
...
while ($error_log) {
    ...
    if ( !$graphviz_path_detected) {
        Write-Output "  WARNING: Graphviz was not detected in PATH!"
        Write-Output "  Please follow instructions provided after executing 'install_reqs.ps1' to set Graphviz within PATH"
        Write-Output ""
        break
    }
    
    if ( !$cmake_path_detected) {
        Write-Output "  WARNING: CMake was not detected in PATH!"
        Write-Output "  Please follow instructions provided after executing 'install_reqs.ps1' to set CMake within PATH"
        Write-Output ""
        break
    }
    ...
    if ( $? -ne 1 ){
        Write-Output "  Failed to change to 'graph_repo' directory from current working directory of ${PWD}."
    ...
    if ( $? -ne 1 ) {
        Write-Output "  Failed to create 'build' directory in cloned repo directory."
    ...
    if ( $? -ne 1 ) {
        Write-Output "  Failed to create 'build/release' subdirectory in cloned repo directory."
        Write-Output "  Aborting setup process.."
        Write-Output "  If you wish to retry at any time, simply delete the 'build' directory and re-run setup script according to README instructions"
        Write-Output "  Please view the README for further information on feature access and troubleshooting: https://github.com/parsokev/graph_repo"
        Set-Location ..
    ...
    if ( $? -ne 1 ) {
        Write-Output "  Failed to create 'build/debug' subdirectory in cloned repo directory."
        Write-Output "  Aborting setup process.."
        Write-Output "  If you wish to retry at any time, simply delete the 'build' directory and re-run setup script according to README instructions"
        Write-Output "  Please view the README for further information on feature access and troubleshooting: https://github.com/parsokev/graph_repo"
        Set-Location ..
    ...
    cmake --build . 
    if ( $? -ne 1 ) {
        Write-Output "  Failed to create CMake 'Release' Configuaration in 'build/release/' subdirectory in cloned repo directory."
    ...
    ninja
    if ( $? -ne 1 ) {
        Write-Output "  Failed to build CMake 'Release' Configuaration in 'build/release/' subdirectory in cloned repo directory."
        Write-Output "  Please ensure you are calling script from top level directory. Aborting setup process.."
        Write-Output "  If you wish to retry at any time, simply delete the 'build' directory and re-run setup script according to README instructions"
        Write-Output "  Please view the README for further information on feature access and troubleshooting: https://github.com/parsokev/graph_repo"
        Set-Location ../../../
        ...
        Write-Output "  'Release' Configuration of CMake Project successfully built!"
    }
    ...
    cmake --build .
    if ( $? -ne 1 ) {
        Write-Output "  Failed to create CMake 'Debug' Configuaration in 'build/debug/' subdirectory in cloned repo directory."
        Write-Output "  Please ensure you are calling script from top level directory. Aborting setup process.."
        Write-Output "  If you wish to retry at any time, simply delete the 'build' directory and re-run setup script according to README instructions"
        Write-Output "  Please view the README for further information on feature access and troubleshooting: https://github.com/parsokev/graph_repo"
        Set-Location ../../../
    ...
    ninja
    if ( $? -ne 1 ) {
        Write-Output "  Failed to build CMake 'Debug' Configuaration in 'build/debug/' subdirectory in cloned repo directory."
        Write-Output "  Please ensure you are calling script from top level directory. Aborting setup process.."
        Write-Output "  If you wish to retry at any time, simply delete the 'build' directory and re-run setup script according to README instructions"
        Write-Output "  Please view the README for further information on feature access and troubleshooting: https://github.com/parsokev/graph_repo"
        Set-Location ../../
        ...
        Write-Output "'Debug' Configuration of CMake Project successfully built!"
    }
    ...
    Write-Output ""
    Write-Output "  Both CMake projects have been successfully built and compiled!"
    Write-Output ""
    Write-Output "  EXECUTING PROGRAM:"
    ...
    Write-Output ""
    Write-Output "  EXECUTING TESTING SUITE:"
    Write-Output "      To Run all tests within GoogleTest testing suite, Enter: './build/release/tests' or './build/debug/tests' for additional reporting"
    Write-Output ""
    Write-Output "  Please view the README for further information on feature access and troubleshooting: https://github.com/parsokev/graph_repo"
    break
}